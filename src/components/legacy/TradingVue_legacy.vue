...
import Toolbar from '@components/Toolbar.vue' // all Vue3 updated
import Widgets from './components/Widgets.vue' // next 1
// tip got re-mount when resize, lol
import TheTip from './components/TheTip.vue' // next 2

// fixed this file as 14, last one
...
export default {
    ...
    mounted() {
        // show tip
        this.showTheTip(this.tipText); // needed to be mounted somewhere else
